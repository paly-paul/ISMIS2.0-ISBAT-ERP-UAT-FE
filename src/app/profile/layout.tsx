...
// (see AcademicLayout / NotificationsLayout) — duplicated for the same
// reason those two duplicate it from one another: this page owns its own
// Sidebar/rail state too.
//
// "My Profile" isn't scoped to one module — it's reached from the header's
// profile dropdown on every module — so like Notifications there's no rail
// this page's own currentPage will ever match; it defaults to the Academic
// rail so the panel isn't empty on arrival.
